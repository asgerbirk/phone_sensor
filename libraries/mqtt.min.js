  ...
  return (function () {
  ...
  })()(
    {
            ...
            u(v, i),
              ...
              (v.prototype.publish = function (e, t, r, n) {
                ...
                switch (
                  ...
                  case 1:
                  case 2:
                    (this.outgoing[i.messageId] = { volatile: !1, cb: n || w }),
              ...
              (v.prototype.end = function (e, t, r) {
                ...
                return (
                  ...
                  (null != e && "boolean" == typeof e) ||
                    ...
                    (e = !1),
                    "object" != typeof t &&
                      ((r = t), (t = null), "function" != typeof r && (r = w))),
                ...
                h("_reconnect: emitting reconnect to client"),
                  ...
                  this.connected
                    ? (this.end(() => {
                      ...
                      h("client already connected. disconnecting first."))
                ...
                if (o) {
                  switch ((h("_handleAck :: packet type", n), n)) {
                    ...
                    case "pubrec":
                      ...
                      var u = e.reasonCode;
                      u && u > 0 && 16 !== u
                        ? (((t = new Error("Publish error: " + m[u])).code = u),
                          o(t, e))
                        : this._sendPacket(i);
                      break;
                    case "suback":
      ...
      2: [
        function (e, t, r) {
          (function (r) {
            ...
            t.exports = function (e, t) {
              ...
              return (
                (n = t.my).connectSocket({ url: l, protocols: c }),
                (i = (function () {
                  var e = new s();
                  return (
        ...
        { buffer: 12, duplexify: 16, "readable-stream": 63 },
      ],
      3: [
        function (e, t, r) {
          "use strict";
            ...
            t.exports = c
              ? function (e, t) {
                  ...
                  let h = (function (e, t) {
                    ...
                    p = (function (e, t, r) {
                      let n = new a({ objectModeMode: e.objectMode });
                      return (n._write = t), (n._flush = r), n;
                    })(
                      t,
                      function e(t, r, o) {
                        h.bufferedAmount > i && setTimeout(e, u, t, r, o),
                          c && "string" == typeof t && (t = n.from(t, "utf8"));
                        try {
                          h.send(t);
                        } catch (e) {
                          return o(e);
                  ...
                  return (
                    ...
                    (r.socket = h),
                    d
                      ? (h.addEventListener("close", b),
                        h.addEventListener("error", m),
                        h.addEventListener("message", y))
                      : ((h.onclose = b), (h.onerror = m), (h.onmessage = y)),
                    r
                  );
                }
              : function (e, t) {
        ...
        function (e, t, r) {
          (function (r) {
            ...
            t.exports = function (e, t) {
              ...
              (n = wx.connectSocket({ url: c, protocols: [u] })),
                (i = (function () {
                  var e = new s();
                  return (
                    (e._write = function (e, t, r) {
      ...
      12: [
        ...
        { "base64-js": 10, buffer: 12, ieee754: 28 },
      ],
      13: [
        function (e, t, r) {
          (function (e) {
      ...
      18: [
        ...
        { "./_stream_transform": 20, "core-util-is": 13, inherits: 29 },
      ],
      19: [
        function (e, t, r) {
          (function (r, n) {
            ...
            (_.prototype.read = function (e) {
              ...
              if (
                ...
                return (
                  ...
                  0 === t.length && t.ended ? O(this) : E(this),
                  null
                );
              ...
              (_.prototype.on = function (e, t) {
                ...
                if ("data" === e)
                  ...
                  n.endEmitted ||
                    ...
                    (n.emittedReadable = !1),
                    n.reading ? n.length && E(this) : i.nextTick(x, this));
                }
                return r;
              }),
      ...
      20: [
        ...
        { "./_stream_duplex": 17, "core-util-is": 13, inherits: 29 },
      ],
      21: [
        function (e, t, r) {
          (function (r, n, i) {
      ...
      33: [
        ...
        { "./writeToStream": 40, buffer: 12, events: 27 },
      ],
      34: [
        function (e, t, r) {
        ...
        { "./generate": 33, "./parser": 39, "./writeToStream": 40 },
      ],
      35: [
        function (e, t, r) {
          "use strict";
          ...
          (o._init = function (e) {
            ...
            (o.prototype.copy = function (e, t, r, i) {
              ...
              if (u <= this._bufs[s[0]].length - l)
                return o
                  ? this._bufs[s[0]].copy(e, t, l, l + u)
                  : this._bufs[s[0]].slice(l, l + u);
              o || (e = n.allocUnsafe(a));
      ...
      36: [
        ...
        { "./BufferList": 35, inherits: 29, "readable-stream": 63 },
      ],
      37: [
        function (e, t, r) {
          (function (e) {
      ...
      39: [
        function (e, t, r) {
          ...
          class u extends i {
            ...
            _parseConnect() {
              ...
              if (((o.protocolId = u), this._pos >= this._list.length))
              ...
              if (
                ...
                i.will &&
                  ...
                  (o.will.retain =
                    0 !=
                    (this._list.readUInt8(this._pos) & s.WILL_RETAIN_MASK)),
                  (o.will.qos =
                    (this._list.readUInt8(this._pos) & s.WILL_QOS_MASK) >>
                    s.WILL_QOS_SHIFT)),
                (o.clean =
                  0 !=
                  (this._list.readUInt8(this._pos) & s.CLEAN_SESSION_MASK)),
                this._pos++,
            ...
            _parseConnack() {
              ...
              if (
                ((e.sessionPresent = !!(
                  this._list.readUInt8(this._pos++) & s.SESSIONPRESENT_MASK
                )),
            ...
            _parseVarByteNum(e) {
              ...
              for (; r < 5; ) {
                if (
                  ((i +=
                    n *
                    ((t = this._list.readUInt8(u + r++)) & s.VARBYTEINT_MASK)),
                  (n *= 128),
            ...
            _parseProperties() {
              ...
              for (; this._pos < t; ) {
                ...
                if ("userProperties" !== t)
                  r[t]
                    ? Array.isArray(r[t])
                      ? r[t].push(this._parseByType(s.propertiesTypes[t]))
                      : ((r[t] = [r[t]]),
                        r[t].push(this._parseByType(s.propertiesTypes[t])))
                    : (r[t] = this._parseByType(s.propertiesTypes[t]));
                else {
        ...
        { "./constants": 32, "./packet": 38, bl: 36, debug: 14, events: 27 },
      ],
      40: [
        function (e, t, r) {
          (function (r) {
                ...
                case "connect":
                  return (function (e, t, i) {
                    ...
                    if (u) {
                      ...
                      if (
                        ((b += r.byteLength(u.topic) + 2), (b += 2), u.payload)
                      ) {
                        if (!(u.payload.length >= 0))
                          return (
                            t.emit("error", new Error("Invalid will payload")),
                            !1
                          );
                        "string" == typeof u.payload
                          ? (b += r.byteLength(u.payload))
                          : (b += u.payload.length);
                      }
                      var y = {};
                      if (5 === a) {
                    ...
                    E(t, f),
                      u &&
                        (5 === a && y.write(), w(t, u.topic), E(t, u.payload));
                    null != h && E(t, h);
                    null != p && E(t, p);
                    return !0;
                  })(e, t);
                  ...
                  return (function (e, t, i) {
                    ...
                    for (const e of l) {
                      ...
                      w(t, i),
                        ...
                        5 === o &&
                          ((l |= a ? n.SUBSCRIBE_OPTIONS_NL : 0),
                          (l |= u ? n.SUBSCRIBE_OPTIONS_RAP : 0),
                          (l |= c ? n.SUBSCRIBE_OPTIONS_RH[c] : 0)),
                        (g = t.write(r.from([l])));
                    }
                    return g;
                  })(e, t, s);
              ...
              function o(t, i) {
                ...
                switch (n.propertiesTypes[t]) {
                  case "byte":
                    if ("boolean" != typeof i)
                      return (
                        e.emit("error", new Error(`Invalid ${t}: ${i}`)), !1
                      );
                    o += 2;
                    break;
                  case "int8":
                  ...
                  default:
                    return (
                      e.emit("error", new Error(`Invalid property ${t}: ${i}`)),
                      !1
                    );
                }
                return o;
            ...
            !(function (n) {
                  ...
                  for (
                    ...
                    i >= w && I("invalid-input"),
                      ((u =
                        ...
                        I("overflow"),
                      (v += u * s),
                      !(u < (p = a <= E ? f : a >= E + h ? h : a - E));
                    a += l
                  )
                    s > k(c / (d = l - p)) && I("overflow"), (s *= d);
                  (E = M(v - o, (t = _.length + 1), 0 == o)),
                    k(v / t) > c - S && I("overflow"),
                    (S += k(v / t)),
                    (v %= t),
                    _.splice(v++, 0, S);
                }
              ...
              function P(e) {
                var t,
                  ...
                  C = [];
                for (
                  _ = (e = x(e)).length, t = b, r = 0, o = g, s = 0;
                  s < _;
                  ++s
                )
                  (y = e[s]) < 128 && C.push(E(y));
                for (n = i = C.length, i && C.push(m); n < _; ) {
                  for (a = c, s = 0; s < _; ++s)
                    (y = e[s]) >= t && y < a && (a = y);
                  for (
                    a - t > k((c - r) / (w = n + 1)) && I("overflow"),
                      r += (a - t) * w,
                      t = a,
                      s = 0;
                    s < _;
                    ...
                    if (((y = e[s]) < t && ++r > c && I("overflow"), y == t)) {
                      for (
                        ...
                        (S = u - d),
                          ...
                          C.push(E(A(d + (S % v), 0))),
                          (u = k(S / v));
                      C.push(E(A(u, 0))), (o = M(r, w, n == i)), (r = 0), ++n;
                    }
                  ++r, ++t;
                }
                return C.join("");
      ...
      51: [
        ...
        { "./_stream_transform": 53, inherits: 29 },
      ],
      52: [
        function (e, t, r) {
          (function (r, n) {
            ...
            (I.prototype.read = function (e) {
              ...
              if (
                ...
                return (
                  ...
                  0 === t.length && t.ended ? q(this) : A(this),
                  null
                );
      ...
      53: [
        ...
        { "../errors": 49, "./_stream_duplex": 50, inherits: 29 },
      ],
      54: [
        function (e, t, r) {
          (function (r, n) {
              ...
              if (e._writev && r && r.next) {
                ...
                for (; r; ) {
                  var c = r.chunk,
                    ...
                    f = r.callback;
                  if (
                    (C(e, t, !1, t.objectMode ? 1 : c.length, c, l, f),
                    (r = r.next),
                    t.bufferedRequestCount--,
                    t.writing)
                  )
            ...
            e("inherits")(I, a),
                ...
                ? ((l = Function.prototype[Symbol.hasInstance]),
                  Object.defineProperty(I, Symbol.hasInstance, {
                    value: function (e) {
                      return (
                        !!l.call(this, e) ||
                        (this === I && e && e._writableState instanceof E)
                      );
                    },
                  }))
                : (l = function (e) {
              ...
              (I.prototype.write = function (e, t, n) {
                var i,
                  ...
                  s = !1,
                  a =
                    !o.objectMode && ((i = e), u.isBuffer(i) || i instanceof c);
                return (
                  a &&
                    !u.isBuffer(e) &&
                    (e = (function (e) {
          ...
          (function (r) {
            ...
            function d(e) {
              ...
              if (null !== t) {
                var r = e[h].read();
                null !== r &&
                  ((e[l] = null), (e[s] = null), (e[a] = null), t(p(r, !1)));
              }
            }
              ...
              return (
                ...
                o(e, function (e) {
                  if (e && "ERR_STREAM_PREMATURE_CLOSE" !== e.code) {
                    ...
                    return (
                      null !== t &&
                        ((n[l] = null), (n[s] = null), (n[a] = null), t(e)),
                      void (n[u] = e)
                    );
                  }
                  var r = n[s];
      ...
      68: [
        ...
        { "process/browser.js": 44, timers: 68 },
      ],
      69: [
        function (e, t, r) {
          "use strict";
          ...
          (o.prototype.parse = function (e, t, r) {
            ...
            if (!b[v] && (k || (v && !m[v]))) {
              for (var E, I, C = -1, T = 0; T < h.length; T++) {
                -1 !== (x = _.indexOf(h[T])) && (-1 === C || x < C) && (C = x);
              }
              -1 !==
                (I = -1 === C ? _.lastIndexOf("@") : _.lastIndexOf("@", C)) &&
                ((E = _.slice(0, I)),
                (_ = _.slice(I + 1)),
              ...
              if (!R)
                for (
                  var A = this.hostname.split(/\./), M = ((T = 0), A.length);
                  T < M;
                  T++
                ) {
                  var O = A[T];
                  if (O && !O.match(p)) {
                    for (var P = "", L = 0, B = O.length; L < B; L++)
                      O.charCodeAt(L) > 127 ? (P += "x") : (P += O[L]);
                    if (!P.match(p)) {
                      var j = A.slice(0, T),
                        U = A.slice(T + 1),
                        N = O.match(d);
                      N && (j.push(N[1]), U.unshift(N[2])),
                        U.length && (_ = "/" + U.join(".") + _),
            ...
            if (
              (-1 !== V
                ? ((this.search = _.substr(V)),
                  (this.query = _.substr(V + 1)),
            ...
            (o.prototype.resolveObject = function (e) {
              ...
              E &&
                ...
                (R =
                  ...
                  ((r.auth = R.shift()), (r.host = r.hostname = R.shift())));
              return (
                (v = v || (r.host && k.length)) && !A && k.unshift(""),
                k.length
                  ? (r.pathname = k.join("/"))
        ...
        { "./util": 70, punycode: 45, querystring: 48 },
      ],
      70: [
        function (e, t, r) {
          "use strict";
